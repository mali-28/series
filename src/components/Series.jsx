...
const Series = ()=>{
    ...
    return <>
        <TopBar />
        <Footer  style={{ marginTop: "20px",marginBottom: "30px", backgroundColor: "#000", color: "#fff", padding: "10px", fontSize: 30,boxSizing : "border-box",}} >Series</Footer>
